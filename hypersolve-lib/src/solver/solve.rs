...
pub fn fast_solve(
    ...
    let cube = Cube::solved().twists(scramble);
    ...
    let orientations = [
        Vec::new(),
        vec![Twist::new(Face::R, TwistDirection::DBL, Layer::Both)],
        vec![Twist::new(Face::R, TwistDirection::UFR, Layer::Both)],
        vec![Twist::new(Face::U, TwistDirection::DBL, Layer::Both)],
        vec![Twist::new(Face::U, TwistDirection::UFR, Layer::Both)],
        vec![Twist::new(Face::F, TwistDirection::DBL, Layer::Both)],
        vec![Twist::new(Face::F, TwistDirection::UFR, Layer::Both)],
        vec![Twist::new(Face::I, TwistDirection::DBL, Layer::Both)],
        vec![Twist::new(Face::I, TwistDirection::UFR, Layer::Both)],
        vec![
            Twist::new(Face::F, TwistDirection::DBL, Layer::Both),
            Twist::new(Face::I, TwistDirection::DBL, Layer::Both),
        ],
        vec![
            Twist::new(Face::F, TwistDirection::UFR, Layer::Both),
            Twist::new(Face::I, TwistDirection::UFR, Layer::Both),
        ],
        vec![
            Twist::new(Face::R, TwistDirection::DBL, Layer::Both),
            Twist::new(Face::I, TwistDirection::DBL, Layer::Both),
        ],
    ]
    .map(TwistSequence);
